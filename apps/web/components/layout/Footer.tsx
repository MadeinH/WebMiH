      ...
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="grid gap-12 md:grid-cols-3">
          ...
          <div className="space-y-4">
            ...
            <div className="hidden rounded-[1.5rem] border border-heaven-divider bg-heaven-bg-card/70 p-4 md:block">
              ...
              <div className="mt-3 flex flex-wrap gap-2">
                <a
                  ...
                  className="inline-flex cursor-pointer items-center gap-2 rounded-full border border-heaven-divider bg-heaven-bg-dark/70 px-4 py-2 text-sm font-semibold text-heaven-text transition-colors duration-200 hover:border-heaven-rose/50 hover:text-heaven-rose"
                >
                ...
                <a
                  ...
                  className="inline-flex cursor-pointer items-center gap-2 rounded-full border border-heaven-divider bg-heaven-bg-dark/70 px-4 py-2 text-sm font-semibold text-heaven-text transition-colors duration-200 hover:border-heaven-sky/50 hover:text-heaven-sky"
                >
                  <svg width="16" height="16" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <div className="mt-12 rounded-[2rem] border border-heaven-divider bg-heaven-bg-card p-6 text-center shadow-heaven-card">
        ...
        <div className="mt-8 flex flex-col items-center justify-between gap-4 sm:flex-row">
          ...
          <div className="flex items-center gap-4">
            {/* Redes sociales: ya se muestran en el panel 'Síguenos' dentro de la columna de marca. */}
          </div>
        </div>
      </div>
    </footer>

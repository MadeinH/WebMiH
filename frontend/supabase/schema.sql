...
insert into public.productos (slug, nombre, descripcion, categoria, subcategoria, material, horma, solo_cotizar) values
  ...
  ('camisa-compresiva', 'Camisa Compresiva Deportiva', 'Camisa compresiva deportiva — solo por cotización.', 'prendas', 'deportiva', 'Poliéster deportivo premium', 'hombre', true);

...
export const defaultAdminContent: AdminContentSnapshot = {
  ...
  catalog: [
    ...
    item({
      type: 'catalog', slug: 'camisa-compresiva-deportiva', nombre: 'Camisa Compresiva Deportiva',
      descripcion: 'Camisa tipo compresiva en poliéster deportivo premium. Disponible solo por mayoreo.',
      subcategoria: 'deportiva', material: 'Poliéster deportivo premium',
      horma: 'Hombre / Mujer / Niño', soloCotizar: false, activo: true, imagenUrl: null, featured: false,
      priceMatrix: pm({ detalCarta: null, detalEstandar: null, mayoreo3: 37500, mayoreo6: 35500, mayoreo12: null }),
    }),
  ],
  ...
  accessories: [
    ...
    item({
      type: 'accessory', slug: 'termos-carimañolas', nombre: 'Termos y Carimañolas',

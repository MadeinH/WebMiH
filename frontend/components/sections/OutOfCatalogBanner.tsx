...
export default function OutOfCatalogBanner() {
  return (
      ...
      <div className="mx-auto max-w-4xl px-6 text-center">
        <div className="rounded-2xl border border-heaven-divider bg-gradient-to-br from-heaven-bg-card to-heaven-bg-dark p-8 md:p-12">
          ...
          <p className="mx-auto mt-4 max-w-lg text-heaven-muted">
            También manejamos ropa para bebé, mascotas, artículos especiales y más.
            Si no lo ves en el catálogo, escríbenos y tratamos de conseguirlo.
          </p>
